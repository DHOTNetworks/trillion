                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text { text: model.vDate; color: "#334155"; font.pixelSize: 11; font.family: "Segoe UI"; width: 85 }
                                Text { text: model.refNo; color: "#16A34A"; font.pixelSize: 11; font.bold: true; font.family: "Segoe UI"; width: 75 }
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text { text: model.vDate; color: "#334155"; font.pixelSize: 11; font.family: "Segoe UI"; width: 85 }
                                Text { text: model.refNo; color: "#2563EB"; font.pixelSize: 11; font.bold: true; font.family: "Segoe UI"; width: 75 }
                                Text { text: model.particulars; color: "#0F172A"; font.pixelSize: 11; Layout.fillWidth: true; elide: Text.ElideRight }
