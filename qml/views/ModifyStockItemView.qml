    ...
    ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    CustomWhiteCombo {
                        ...
                        onReturnPressed: {
                            root.loadSelectedItem(selectItemCombo.currentText)
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            CustomInput {
                                ...
                                onUpPressed: selectItemCombo.forceActiveFocus()
                            }
                        ...
                        RowLayout {
                            ...
                            CustomInput {
                                ...
                                onReturnPressed: {
                                    ...
                                    else updateBtn.forceActiveFocus()
                                }
                                onDownPressed: {
                                    if (root.isMandiOrBoth) u1.forceActiveFocus()
                                    else updateBtn.forceActiveFocus()
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        GridLayout {
                            ...
                            CustomInput { id: l3; text: "0.00"; Layout.fillWidth: true; onReturnPressed: updateBtn.forceActiveFocus(); onUpPressed: s3.forceActiveFocus() }
                        }
                    }
                }
        ...
        RowLayout {
            ...
            T.Button {
                ...
                implicitWidth: 280
                implicitHeight: 38
                Keys.onReturnPressed: function(event) { event.accepted = true; root.updateStockItem(); }
                Keys.onEnterPressed: function(event) { event.accepted = true; root.updateStockItem(); }
                background: Rectangle {
