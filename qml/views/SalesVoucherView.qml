    ...
    function recalculateTotals() {
        ...
        if (typeof salesVoucherCtrl !== "undefined" && salesVoucherCtrl) {
            ...
            if (!isManualGst && typeof gstTaxInput !== "undefined" && gstTaxInput) {
                gstTaxInput.text = salesVoucherCtrl.totalTaxAmount > 0 ? salesVoucherCtrl.totalTaxAmount.toFixed(2) : "0.00"
            }
        }
    }
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Item { Layout.preferredWidth: 120; Layout.minimumWidth: 120; Layout.maximumWidth: 120; Text { anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter; text: "₹" + Number(model.amount || model.total_amount || 0).toFixed(2); color: "#2563EB"; font.pixelSize: 12; font.bold: true } }
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Item { Layout.preferredWidth: 35; Layout.minimumWidth: 35; Layout.maximumWidth: 35; Text { anchors.verticalCenter: parent.verticalCenter; text: (itemsListView.count + 1) + "."; color: "#2563EB"; font.pixelSize: 12; font.bold: true } }
