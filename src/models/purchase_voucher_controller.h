...
class PurchaseLineItemsModel : public QAbstractListModel {
    Q_OBJECT
...
public:
    ...
    explicit PurchaseLineItemsModel(QObject *parent = nullptr);
    ...
    const QVector<PurchaseLineItem>& items() const { return m_items; }
...
private:
    QVector<PurchaseLineItem> m_items;
};

class PurchaseVoucherController : public QObject {
    Q_OBJECT
    ...
    Q_PROPERTY(QString purchaseAccount READ purchaseAccount WRITE setPurchaseAccount NOTIFY purchaseAccountChanged)
    ...
    // Line Items Model
    Q_PROPERTY(PurchaseLineItemsModel* lineItemsModel READ lineItemsModel CONSTANT)
...
public:
    explicit PurchaseVoucherController(QObject *parent = nullptr);
    ...
    QString purchaseAccount() const { return m_purchaseAccount; }
    void setPurchaseAccount(const QString &v) { if (m_purchaseAccount != v) { m_purchaseAccount = v; emit purchaseAccountChanged(); } }
    ...
    PurchaseLineItemsModel* lineItemsModel() { return &m_lineItemsModel; }
...
private:
    ...
    QString m_saleStatus = "Self Purchase";
    ...
    QString m_gstin;
    int m_dueDays = 30;
    QString m_purchaseAccount = "Purchase Account";
    ...
    PurchaseLineItemsModel m_lineItemsModel;
};
