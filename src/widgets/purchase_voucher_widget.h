...
class PurchaseVoucherWidget : public QWidget {
    Q_OBJECT

public:
    explicit PurchaseVoucherWidget(PrintExportController* printExportCtrl = nullptr,
                                  QWidget* parent = nullptr);
    ~PurchaseVoucherWidget() override;
...
private:
    ...
    PurchaseVoucherController m_controller;
    PurchaseModel m_purchaseModel;
    ...
    // Top Bar Controls
    QLabel* m_purchaseBadge = nullptr;
    ...
    // Mandi Status Radio Group (Mandi Type)
