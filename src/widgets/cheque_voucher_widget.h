...
class ChequeVoucherWidget : public QWidget {
    Q_OBJECT

public:
    explicit ChequeVoucherWidget(PrintExportController* printExportCtrl = nullptr,
                                 QWidget* parent = nullptr);
    ~ChequeVoucherWidget() override = default;
...
private:
    ...
    ChequeVoucherController m_controller;
