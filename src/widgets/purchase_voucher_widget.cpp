...
void PurchaseVoucherWidget::setupUi() {
    ...
    setStyleSheet(
        "PurchaseVoucherWidget { background-color: #FFF3EA; font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', 'Noto Sans', 'Liberation Sans', Arial, sans-serif; }"
        ...
        "QRadioButton::indicator:checked { width: 14px; height: 14px; border-radius: 7px; border: 4.5px solid #16A34A; background-color: #FFFFFF; }"
    ...
    m_purchaseBadge->setStyleSheet("background-color: #FEF2F2; color: #DC2626; font-weight: 900; font-size: 12px; padding: 1px 10px; border: 1px solid #FECACA; border-radius: 5px;");
