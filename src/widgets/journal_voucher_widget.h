...
class JournalVoucherWidget : public QWidget {
    Q_OBJECT

public:
    explicit JournalVoucherWidget(PrintExportController* printExportCtrl = nullptr,
                                 QWidget* parent = nullptr);
    ~JournalVoucherWidget() override = default;
...
private:
    ...
    JournalVoucherController m_controller;
